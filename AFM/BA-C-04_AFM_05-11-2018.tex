...
\begin{document}
	...
	%TODO hier iwo schreiben wie wir adhäsion bestimmen aus snap-off mit Graphik
	%TODO noch allgemeiner
	...
	Hierbei wird die Spitze mit einer bestimmten Kraft (Normalkraft) auf die Probe gedrückt, die nach dem Hookeschen Gesetz einer bestimmten Verbiegung des Cantilevers entspricht. %TODO worauf bezieht sich 'Hierbei', KDS?
	...
	Die Verbiegung des Cantilevers wird durch einen PID-Regler möglichst konstant gehalten, sodass die Abweichung der auf den Cantilever ausgewirkten Kraft von der Normalkraft abhängig von der z-Position der Spitze ist. %das war doch hier auch schon PID, oder? %TODO Nein, weil es schwingt ja nix (theoretisch könnte man sagen es ist nur P-Regler aber macht glaub net Sinn)
	...
	Da die Adhäsionskräfte zwischen Probe und Cantilever die effektive Rückstellkraft des Cantilevers verändern, ändert sich die Resonanzfrequenz in Abhängigkeit vom Probe-Spitze-Abstand. %TODO Adhäsion wiederspricht Non-COntact mode. Wechselwikung mit Probenoberfläche (ohne Kontakt) reduziert REsonanzfrequenz (wenn Kraft attraktiv)
	Abhängig davon, ob dieser Abstand steigt oder sinkt, nähert sich die Resonanzfrequenz also der Anregungsfrequenz an oder entfernt sich von ihr. %TODO  +Die Amplitude ändert sich weil Anregung entsprechend effektiver
  ...
  %TODO häufig verschmutzngen/unschön => trial and error.
...
\caption{Kraft-Abstand-Spektroskopie Kurve der Kalibrierungsprobe auf einem der Maxima.}
\end{figure}
