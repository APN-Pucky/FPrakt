...
\begin{document}
	...
	% snap-offs 26.287, 28, 25.557, 35.1, 29.6 => 24.1
	...
	\end{equation}
	Es folgt $F_\text{adh}=\SI{9.5+-9.0}{nN}$, wobei über die fünf gemessenen Hysteresen (\crefrange{fig_kali_ds1}{fig_kali_ds5}) gemittelt wird.
	\subsubsection{CD/DVD/BR}
	\subsubsection*{DVD}
	% snap-offs 39.84, 44.20, 42.44, 49.95, 46.16 => 44.5
	Aus den Messungen \crefrange{fig_dvd_ds1}{fig_dvd_ds5} folgt eine Adhäsionskraft von $F_\text{adh}=\SI{17.6+-16.7}{nN}$
	\subsubsection*{CD}
	% snap-offs 47.84, 53.66, 53.48, 50.21, 47.75 => 50.6
	Aus den Messungen \crefrange{fig_cd_ds1}{fig_cd_ds5} folgt eine Adhäsionskraft von $F_\text{adh}=\SI{20.0+-19.0}{nN}$
	\subsubsection*{BR}
	% snap-offs 33.33, 35.63, 35.27, 35.67, 36.36 => 35.3
	Aus den Messungen \crefrange{fig_br_ds1}{fig_br_ds5} folgt eine Adhäsionskraft von $F_\text{adh}=\SI{14.0+-13.3}{nN}$
	% 1) DVD
	% 2) CD
	% 3) BR
...
\begin{figure}[H]
			...
			\caption{Kraft-Abstands-Spektroskopie der Probe 3. in einem der Minima} % Pit oder Peak?
\end{figure}
