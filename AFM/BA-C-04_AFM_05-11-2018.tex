...
\begin{document}
	...
	Die Raster-Kraft-Mikroskopie (AFM von engl. atomic force microscopy) ist ein Verfahren, welches es erlaubt mit optisch nicht erreichbarer Auflösung Oberflächenprofile zu erstellen sowie Kräfte zwischen Oberfläche und Probe zu bestimmen.
	...
	Die gemessen Topografien weisen einen Höhengradienten auf und häufig fällt die gemessene Höhe nach einem Maximum nicht mehr auf Null zurück.
...
In alle Raumrichtungen wurde mit einem Faktor von $2/3$ multipliziert.
\begin{figure}[H]
			\subcaptionbox{Draufsicht \label{fig_kali_top}}{\includegraphics[width=.49\linewidth]{images/Kali/Top}}
			\subcaptionbox{3D-Sicht \label{fig_kali_3d}}{\includegraphics[width=.49\linewidth]{images/Kali/3D_fix}}
...
\caption{Kraft-Abstands-Kurve der Kalibrierprobe auf einem der Maxima.}
\label{fig_kali_expl}
\end{figure}
...
\begin{figure}[H]
			...
			\subcaptionbox{3D-Sicht \label{fig_dvd_3d}}{\includegraphics[width=.49\linewidth]{images/DVD/3D_fix}}
...
\begin{figure}[H]
			...
			\subcaptionbox{3D-Sicht \label{fig_cd_3d}}{\includegraphics[width=.49\linewidth]{images/CD/3D_fix}}
			\subcaptionbox{Vergrößerte Draufsicht \label{fig_cd_top_zoom}}{\includegraphics[width=.49\linewidth]{images/CD/Top_zoom}}
			\subcaptionbox{Vergrößerte 3D-Sicht \label{fig_cd_3d_zoom}}{\includegraphics[width=.49\linewidth]{images/CD/3D_zoom_fix}}
...
\begin{figure}[H] %Hier finde ich die Vergrößerte Sicht sehr merkwürdig (und eigentlich auch die nicht-vergrößerte)
			...
			\subcaptionbox{3D-Sicht \label{fig_br_3d}}{\includegraphics[width=.49\linewidth]{images/BR/3D_fix}}
			\subcaptionbox{Vergrößerte Draufsicht \label{fig_br_top_zoom}}{\includegraphics[width=.49\linewidth]{images/BR/Top_zoom}}
			\subcaptionbox{Vergrößerte 3D-Sicht \label{fig_br_3d_zoom}}{\includegraphics[width=.49\linewidth]{images/BR/3D_zoom_fix}}
...
\begin{figure}[H]
			...
			\label{fig_tgt_3d}}{\includegraphics[width=.49\linewidth]{images/TGT/3D_fix}}
...
\begin{figure}[H]
			...
			\subcaptionbox{3D-Sicht
			\label{fig_tgt_3d_zoom}}{\includegraphics[width=.49\linewidth]{images/TGT/3D_zoom_fix}}
...
\end{figure}
	...
	Außerdem fällt in \cref{fig_tgt_top_zoom} auf, die Spitzen eine dreieckige Form haben und in \cref{fig_tgt_3d_zoom} nicht sonderlich spitz zulaufen, aber selten im Profil einen Kreis bilden.
	...
	Eine Messung im Vakuum (nach Befreiung von Oberflächenwasser durch Erhitzen) oder in Wasser würde ermöglichen die Kapillarkraft zu eliminieren, weshalb diese aus der Differenz der Messung im Vakuum und an der Luft bestimmt werden könnte.
