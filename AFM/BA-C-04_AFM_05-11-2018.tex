...
\begin{figure}[H]
			\subcaptionbox{Draufsicht
			 \label{fig_tgt_top}}{\includegraphics[width=.49\linewidth]{images/TGT/Top_zoom}}
			\subcaptionbox{3D-Sicht
			\label{fig_tgt_3d}}{\includegraphics[width=.49\linewidth]{images/TGT/3D_zoom}}
			\subcaptionbox{Profil 1. Fit ist ein Kreis mit dem Radius r= \SI{1.2037 +-0.016}{\mu m}
			\label{fig_tgt_profil}}{\includegraphics[width=.99\linewidth]{images/TGT/Profil_zoom}}
			\caption{TGT1 Probe.}
\end{figure}
