...
\begin{document}
	...
	\begin{table}[H]
		...
		\caption{Gemessene Röntgenfluoreszenzmaxima. Die charakteristischen Übergangsenergien sind die experimentellen Werte aus \cite{XRAYDB}. Diese sind Messwerte aus \cref{tb_peaks_known}.} %TODO auch hier die E_index wie oben?
	...
	\begin{table}[H]
		...
		\end{tabular}
		\caption{Höhen verschiedener Peaks.} %TODO mehr
		\label{tb_peaks} 
	\end{table}	
