...
\begin{document}
	...
	Diese Winkel werden mit dem Goniometer eingestellt, obwohl die Verwendung dies zu einer Stellung führt, die nach Augenmaß nicht exakt den gewünschten Winkeln entspricht. %TODO so ok?
	...
	\begin{figure}[H]
		\includegraphics[width=0.6\textwidth]{images/Silbermuenze}
		\centering
