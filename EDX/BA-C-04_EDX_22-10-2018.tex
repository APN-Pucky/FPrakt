...
\begin{document}
	...
	\begin{titlepage}
		...
		\vspace{1cm}
		{\scshape\large -korrigierte Version- \par}
		\vspace{2.5cm}
	...
	Im Anhang befinden sich alle gemessenen Spektren sowie die gefitteten Gauß-Kurven.
	\begin{figure}[H]
	...
	\begin{table}[H]
		...
		Die eingeklammerten Werte sind trotz erwarteter Reinheit der Stoffe vermutlich Verunreinigungen.}
	...
	\begin{table}[H]
		...
		\begin{tabular}{ c | c | c || c | c | c }
			...
			& \SI{14.7821+-0.182134}{} &\SI{4}{\%}&Pb &L$_\gamma$&  \SI{  14 .7915(52)    }{} \\
			\hline
	...
	% Abweichung vom Fit diskutieren: 1,5 im Vergleich zu <1 (sigma_n21 ist wohl gemeint). Sigma ist nicht konstant -> nimmt mit hohem Z ab <=> geringes Z (~0, Fit y-Achsenschnitt) hohes sigma, da linearer Fit => habe ich ja gesagt...
	...
	Dies deutet auf mit eine Abweichung aufgrund der Kalibrierung hin.
	...
	\begin{enumerate}
		...
		\item[Probe 11] würde auf Basis der Angaben von \cite{XRAYDB} sogar mit recht hoher Gewissheit (aufgrund drei  gut übereinstimmender Peaks) als Holmium identifiziert werden. Da Holmium jedoch zu den seltenen Erden zählt, kann es als recht unwahrscheinlich angesehen werden, dass eine Probe aus Holmium bereitgestellt wurde, was zeigt, dass die Methode der Röntgenspektroskopie hier versagt hat.
		\item[Probe 12] kann auf Basis der Angaben von \cite{XRAYDB} als Blei identifiziert werden.
		\item[Probe 13] Je zwei Übergänge können Kupfer und Yttrium zugeordnet werden. Der fünfte Übergang ist schwieriger zuzuordnen. Da jedoch Yttrium-Barium-Kupferoxid ein wichtiger Hochtemperatursupraleiter ist, wird angenommen, dass er Barium zugeordnet. Peaks von Sauerstoff wurden nicht gefunden, was wohl damit zusammenhängt, weil die energiedispersive Röntgenspektroskopie für geringe Ordnungszahlen ungeeignet ist, da die Übergänge im Sauerstoff außerhalb des Messbereichs liegen.
