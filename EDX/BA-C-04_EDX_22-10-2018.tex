...
\begin{document}
	...
	\section{Kurzfassung} %TODO ist kurz
...
-Was ist die kleinste Energie, die detektiert werden kann? ->siehe Angaben für Detektor-> Das ergibt, dass manche Linien später nicht ernst genommen werden können (min. eine).
...
\fi
	...
	\subsection{Beobachtung} %TODO alle Spektren mit Fits drin.
	...
	\begin{table}[H]
		...
		\begin{tabular}{ c | c | c || c | c | c }
			...
			& \SI{2.54705+-0.281081}{} &\SI{3}{\%}&-& -&  -\SI{}{} \\ %TODO vlt. Mo+Zr
			& \SI{4.54007+-0.135133}{} &\SI{95}{\%}&Ti& $\text{K}_\alpha$ &  \SI{4. 5108991(94)}{} \\
			& \SI{6.40999+-0.148897}{} &\SI{1}{\%}&-&- &  -\SI{}{} \\ %TODO Fe?
			\hline

			8 (Mo)
			& \SI{7.79212+-0.286311}{} &\SI{3}{\%}&-& -&  -\SI{}{} \\ %TODO vlt. Ni+Cu
			& \SI{11.1937+-0.293367}{} &\SI{3}{\%}&-&- &  -\SI{}{} \\ %TODO Se?
	...
	\begin{table}[H] %TODO "Vgl. mit Literaturwerten bietet sich an."
		\centering
		\begin{tabular}{ c | c | c}
			Element & $\sigma_{n21}$ ($\text{K}_\alpha$) &  $\sigma_{n21}$  ($\text{K}_\beta$)\\ \hline \hline %TODO angeblicher Rechteschreibfehler
	...
	\begin{enumerate}
		...
		\item[Probe 13] Je zwei Übergänge können Kupfer und Yttrium zugeordnet werden. Der fünfte Übergang ist schwieriger zuzuordnen. Die Wahrscheinlichkeit, dass es sich tatsächlich um den $\text{L}_\beta$-Übergang im Iod handelt, ist eher gering, da dann auch andere Übergange des Iods im Spektrum zu erwarten wären. %TODO Kupfer+Yttrium+Barium
