...
\begin{document}
	...
	\begin{table}[H]
		...
		\begin{tabular}{ c | c || c | c | c }
			...
			20 (Kronkorken) & \SI{4.52319+-0.305646}{} & Sn & $\text{L}_\beta $ &  \SI{4,37683(46)}{} \\ %Ti wäre näher dran
			& \SI{6.35883+-0.22392}{} & Fe & $\text{K}_\alpha $ &  \SI{6,3910264(99)}{} \\
			& \SI{7.03423+-0.206604}{} & Fe & $\text{K}_\beta $ &  \SI{7,058175(16)}{} \\ \hline
		\end{tabular}
		}
		\caption{Gemessene Röntgenfluoreszenzmaxima. Die charakteristischen Übergangsenergien sind die experimentellen Werte aus \cite{XRAYDB}.} %TODO auch hier die E_index wie oben?
