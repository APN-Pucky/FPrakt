...
\begin{document}
	...
	%TODO Abweichung vom Fit diskutieren: 1,5 im Vergleich zu <1 (sigma_n21 ist wohl gemeint). Sigma ist nicht konstant -> nimmt mit hohem Z ab <=> geringes Z (~0, Fit y-Achsenschnitt) hohes sigma, da linearer Fit
	...
	%TODO ich schätze, ich sollte hier noch was sagen, warum das so ist, aber kp, was das sein könnte. Kalibrierung ist immmer möglich.
