...
\begin{document}
	...
	Die Energiedispersive Röntgenspektroskopie ist ein Verfahren, welches es erlaubt mithilfe des von einer Probe, die von einem Röntgenstrahl mit kontinuierlichem Spektrum beschossen wird, ausgesandten Röntgenfluoreszenzspektrums die Zusammensetzung der Probe zu bestimmen.
	...
	Dies ist jedoch nur innerhalb großer Unsicherheiten möglich.
	...
	\begin{table}[H]
		...
		\resizebox{\textwidth}{!}{
		\begin{tabular}{ c | c | c || c | c | c }
			Probe (Angabe)&Energie $E_\text{Mess}$ in \SI{}{keV} & rel. Höhe&  vermt. Element & char. Übergang &  Energie $E_\text{NIST}$ in \SI{}{keV} \\ \hline \hline					
