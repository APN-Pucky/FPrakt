...
\begin{document}
	...
	Das Michelson-Interferometer stellt ein mächtiges Werkzeug zur Untersuchung von Materialeigenschaften und Lichteigenschaften dar.
	In diesem Versuch wird es einerseits verwendet, um die Wellenlänge eines Lasers zu überprüfen, wobei die  aufgrund des verwendeten Laser-Typs getroffene Annahme bestätigt werden kann.
	...
	Dies ergibt einen Messwert von \SI{1.707+-0.013}{}, was der Annahme, dass es sich um Glas handelt, nicht widerspricht. %TODO letzter teil kann weg, wenn dus net magst...
	...
	Es ergibt sich ein Zusammenhang zwischen Wellenlänge $\lambda$, Änderung der Länge des Arms $\Delta s$ und Zahl der durchlaufenden Interferenzringe $m$ von %TODO Ich hab jetzt keine knackigere Erklärung, warum die Gleichung genau so ist. ist halt anschaulich klar, aber kp, ob das genug erläutert ist.
	\begin{equation}
	...
	\begin{figure}[H]
		...
		\centering
		\caption{Skizze der Glasplatte in zwei Zuständen: Einfallswinkel $\alpha= 0$ (gestrichelter Quader) und $\alpha>0$ (ausgefüllter Quader).\cite{GlasFormula}} %TODO gestrichelt fine? Quader/Quadrat %TODO cite right?
...
\begin{figure}[H]
	...
	So hat zum Beispiel BASF-64-Glas einen Brechungsindex von \SI{1.6961}{} bei einer Wellenlänge von \SI{650}{nm}.\cite{Brechungsindizes}
		...
		\begin{tabular}{| c | c | c |}
			\hline
			  Gas &  $\Delta p/\Delta m$ & $n(p=\SI{1013}{mbar})$\\ \hline
				...
				\hline
		\end{tabular}
		\caption{Ergebnisse von $\Delta p/\Delta m$ aus den Fits in \crefrange{fig_luft_raus}{fig_co2_rein}. Die Brechungsindizes bei Normaldruck wurden aus den durchlaufenden Interferenzringen pro Druckänderung mit \cref{eq_brech_p} bestimmt.} %TODO in tabelle welches steigt und welches abfällt?
		\label{tb_gase}
	\end{table}
