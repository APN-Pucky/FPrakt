...
\begin{document}
	...
	Hierbei wird ein %TODO vergleich der Werte co2 vs. luft
...
%TODO zu kurz...
	...
	Der Fit liefert einen Brechungsindex von \SI{1.707+-0.013}{} für die Glasplatte bei der verwendeten Wellenlänge $\lambda$ von \SI{650.4+-10.8}{nm}. %TODO Fit gemäß gleichung bla? steht halt nur in der caption
...
\begin{figure}[H]
		...
		\centering
		\caption{In der Küvette befindet sich CO$^2$. Der Druck wird schrittweise reduziert. Die gelbe Funktion ist ein linearer Fit.}
		\label{fig_co2_raus}
	\end{figure}
\begin{figure}[H]
		\includegraphics[width=0.9\textwidth]{images/CO2_Rein.pdf}
		\centering
		\caption{In der Küvette befindet sich CO$^2$. Der Druck wird schrittweise erhöht. Die gelbe Funktion ist ein linearer Fit.}
		\label{fig_co2_rein}
	\end{figure}
