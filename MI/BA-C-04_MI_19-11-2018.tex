		...
		\begin{tabular}{| c | c | c |}
			\hline
			  Gas &  $\Delta p/\Delta m$ & $n(p=\SI{1013}{mbar})$\\ \hline
				...
				\hline
		\end{tabular}
		\caption{Die Brechungsindizes bei Normaldruck wurden mit \cref{eq_brech_p} bestimmtet.} %TODO in tabelle welches steigt und welches abfällt? %TODO besserer Text
		\label{tb_gase}
	\end{table}
