...
\begin{document}
	...
	Außerdem wird ein Höhenprofil der Ladungsträgerkonzentration in einer Probe mit vollständiger Phosphordotierung und beidseitiger Ga-Diffusion mit begrenzter Eindringtiefe angefertigt. %TODO Höhenprofil find ich weird aber bin maybe nur ich %TODO eineseite von der Ga-Diffusion war doch bereits weg
	...
	Ein Vergleich zwischen den Solarzellen ist jedoch nicht möglich. %TODO naja man kann Füllfaktoren und U_oc I_sc vergleichen ist nur nicht so ganz ertragreich
  ...
  \section{Theorie}
	...
	Diese Raumladungszone sorgt für die vielfältigen Eigenschaften des pn-Übergangs, der auch Diode genannt wird: %TODO Diode ist doch auch anders möglich, nicht nur pn
	...
	\end{equation}
	%TODO ok, sehe zwar nicht direkt die Notwendigkeit hierfür
	...
	Wenn der Widerstand des Widerstands, über den die Enden des Halbleiters verbunden sind, verschwindet stellt sich der sog. Kurzschlussstrom $ I_\text{sc} = - I_\text{ph}$ ein. %TODO Widerstand des Widerstands? Maybe direkt wenn man kurzschließt?
	...
	Es sollen für eine Tandemsolarzelle und eine Solarzelle aus polykristallinem Silizium I-U-Kennlinien aufgenommen werden. %TODO erwähnen was Tandem ist
	...
	Dadurch ergibt sich eine tiefenabhängige Dotierung, die untersucht werden soll, indem schrittweise Schichten abgetragen werden und jeweils wie oben die Dicke und der Widerstand gemessen. %TODO eine Ga Seite war schon weg.
	...
	Außerdem kann die Gültigkeit der vorgenommenen Rechnungen aufgrund der Übereinstimmung mit den DIN-Tabellen gezeigt werden. %TODO naja nur die größen Ordnung, imo
	...
	Danach nimmt die Galliumkonzentration weiter ab (dieser Bereich konnte nicht gemessen werden), bis nur noch Phosphordotierung vorliegt. %TODO naja nur so halb nicht gemessen ich habe ja die 3 dafür genommen. imo eher sage, dass man mehr MEsspunkte braucht damit error verschwindet
...
\end{table}
	...
	Dies liegt daran, dass mit steigender Temperatur die Größe der Bandlücke sinkt, sodass die angeregten Elektronen durch graduelle Abstrahlung energetisch tiefer sinken können und somit mehr Energie verlieren, die nicht in elektrische Leistung umgesetzt werden kann. %TODO ändert sich wirklich die Bandlücke oder haben randoms nur mehr (therm-)Energie und jumpen ins Band?
	...
	Insgesamt gesehen konnten die geplanten Messungen durchgeführt werden und die Eigenschaften der untersuchten Halbleiter Solarzellen erfolgreich untersucht werden.
