...
\begin{document}
  ...
  \section{Theorie}
	...
	\subsubsection*{Dotierungskonzentrationen} %TODO Dotierungs oder Dotierung - konz.
	...
	bzw.
	\begin{equation}
			p =\frac{c}{n}=  \mp\sqrt{\left(\frac{1}{2e\mu_p\rho}\right)^2-c\mu_n/\mu_p}+\frac{1}{2e\mu_p \rho} %TODO u(n)
	\end{equation}
	...
	Für die intrinsische Ge-Probe gilt $n_i=n=p$.  % https://www.tf.uni-kiel.de/matwis/amat/mw_for_et/kap_9/backbone/r9_1_1.html
	Also:
	\begin{equation}
	...
	\begin{figure}[H]
			...
			\caption{
				...
				Der Diodenkennlinien Fit ist deutlich schöner unter Vernachlässigung des Messwerts bei $U=\SI{0.8}{V}$. %TODO schön, meh.
								}
