...
P1, P2: Polarisatoren; S: Schalter, V: Spannungsquelle. \cite{displayHelix}
	...
	Dies führt bei einem zum Direktor nicht exakt parallelen Strahl zum Phänomen der Doppelbrechung. %TODO approven, dunno: meintest du nicht wir wissen nicht wie das relativ zum Direktor ist => also kann entweder durchgeghen oder eliminiert werden. %TODO minimum 'parallel polarisiert'
...
\end{table}
	...
	%TODO FLackern, aber kp, gibt es Spannungsschwankungen bei U=0V ?
