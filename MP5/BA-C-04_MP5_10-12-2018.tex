...
flüssigen Kristalle \par} %den Rechtschreibfehler muss man wohl nicht übernehmen...
	...
	%TODO FRagen aus Einleitung, aber halt nur passiv beantworten.
	 %TODO LED Lichtmess modus ala Fallnich? Gegenschaltung und so. Ist nur der Messapperat, aber Preuss meinte Ja auch man solle das Kanalgerät erklären.
	...
	Orientierungsfernordnung meint, dass eine Vorzugsrichtung der Längsachsen der Moleküle des Kristalls existiert.
	Diese kann periodisch ortsabhängig sein. %TODO klar? weil Helix halt. Ja aber nicht intuitiv Bild/Bsp?
	...
	Die Orientierung der Ebenen ist dabei periodisch und der Direktor dreht sich, wenn in Laufrichtung senkrecht zur Ebene betrachtet mit konstanter Winkelgeschwindigkeit und bildet eine Helixstruktur, wenn das Ende des Direktorvektors verfolgt wird. %TODO uh, Bild maybe, weil so ist das schwer nur mit Worten verständlich. %TODO winkelgeschwindigkeit implziert bewegung, eher nur Rotation

	Dies erlaubt den Bau einer Flüssigkristallanzeige, da sich in einem Flüssigkristall in cholesterischer Mesophase die Polarisation des Lichtes, wenn es entlang besagter Laufrichtung einfällt, periodisch mit dem Direktor ändert. %TODO periodisch oder schrittweise?
	...
	%TODO der einfallende Strahl ist unpolarisiert erwähnen?
	...
	Wenn der Flüssigkristall in einem keilförmigen Gefäß ist, behält der Strahl nach dem Austritt aus dem Kristall eine Winkelaufspaltung, weshalb in größerem Abstand die Aufspaltung einfacher gemessen werden kann.
  ...
  Die Differenz der Brechungsindizes ist dabei direkt abhängig vom Ordnungsgrad, weshalb sie als ein Maß für diesen verwendet werden kann.
	...
	%TODO elektrische/optische Eigenschaften/Strukur präziser
  ...
  Sobal der Flüssigkristall im Innern verteilt ist, werden die übrigen Seiten mit Kleber verschlossen.
	...
	\begin{figure}[H]
			...
			\caption{
			Konstruktionsskizze des LC-Displays \cite{imp08}. Die Rillen in beiden Platten sind umm \SI{90}{\degree} gegeneineander verdreht.
			}
			\label{fig_ohnestern}
	\end{figure}
	...
	Die Temperatur, ab der der Abstand der Teilstrahlen verschwindet, entspricht der kritischen Temperatur des Phasenübergangs von nematischer zu isotroper Phase. %TODO Bild aus Anleitung?
	...
	Um von der an der Photodiode gemessenen Spannung auf auf die relative Transmission zu schließen wird %TODO erklären wie Diode Licht intensität messen tut? %TODO von der an der... %TODO ist in Theorie
	\begin{equation}
...
\end{table}
	...
	%TODO Betrachtung anwenden, amybe was besseresm, aber sonst nicht so wichtig
	...
	%TODO ich würde eher sagen ein kleines Delta U ist Grund für flimmern (oder lowlevel Produktion), aber imo halt auch net so stark
	...
	%TODO habe noch mal gedenkt, könnte der industrielle nicht auch einfach nur nen fake widerstand drin haben zum Trollen?
