...
\begin{document}
  ...
  \section{Theorie}
	...
	\end{equation}
	Das Ergebnis für die Glasprobe ist $2\bar{\theta}=\SI{42.2+-1.3}{\degree}$ und für die kristalline Probe befinden sich die gemittelten Peakpositionen in \cref{tb_xrd_result}.
	\begin{table}[H]
		\centering
		\begin{tabular}{ c | c | c | c | c}
			 & Peak 1 & Peak 2 & Peak 3 & Peak 4\\ \hline
			 $2\bar{\theta}$&\SI{39.7+-0.6}{\degree} & \SI{40.52+-0.19}{\degree} &\SI{41.59+-0.16}{\degree} & \SI{43.6+-0.43}{\degree} \\
		\end{tabular}
		\caption{Positionen und Breiten der Diffraktogramm Peaks.}
		\label{tb_xrd_result}
\end{table}
%TODO div theta by two und Bragg für Abstände d ; 2 d sin theta = lambda
 ...
 Die Unsicherheit durch die Digitalanzeige (vgl. \ref{sss_vicker_unsicher}) verschwindet gegenüber Standardabweichung der Mittelwerte.
	...
	\end{figure}
	\begin{figure}[H]
			\includegraphics[width=\linewidth]{img/XRD_Kristallin_41,5_0,5.pdf}
			\caption{
				Vergrößertes Diffraktogramm der kristallinen Probe.
				Die Fitfunktionen sind Gaussfunktionen nach \cref{eq_gauss}.
				Die für den Fit einbezogenen Messpunkte entstammen dem Intervall in welchem die jeweilige Gaussfunktion abgebildet ist.
