...
\begin{document}
  ...
  \section{Theorie}
	...
	Jedoch ist die Schwankung während der Messung deutlich größer als die so abgeschätze Unsicherheit und weshalb diese vernachlässigt werden kann. %TODO Deutsch
	\begin{figure}[H]
