...
\end{table}
	...
	%TODO nur einen Cycle weil kapputt dann antistruktur Abgezogen erwähn in methode
	Es wurden die Thermogramme \crefrange{fig_themo_pdnip_20}{fig_themo_pdnip_100} für verschieden schwere PdNiP-Proben gemessen.
...
\begin{table}[H]
		...
		\end{tabular}
		\caption{
		Verschiedene gemessene Kristallisationsenthalpie der PdNiP-Proben.
		}
...
\end{table}
	...
	\end{equation}
	Hier bei ist $T_p$ die Kristallisationspeaktemperatur und $\alpha$ die zur selben Messung gehörende Heizrate.
...
\begin{figure}[H]
	...
	Der Literaturwert der Schmelzenthalpie von Blei beträgt \SI{4,8}{\kilo \joule \per \mol} \cite{blei_enthalpie}. %TODO why not this: http://www.periodensystem-online.de/index.php?id=bonds&el=82 passt besser
	...
	Aus dem Abschnitt ohne Probe lässt sich gut eine Unsicherheit und der Untergrund abschätzen, da man ohne eine Probe keine Ereignisse erwartet. %TODO ist irgendwie nicht "gut", wenn man danach sagt, dass es nicht gut ist. Naja das gut ist spezifisch für Untergrund
