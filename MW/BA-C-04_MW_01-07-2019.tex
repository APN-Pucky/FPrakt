...
\begin{document}
  ...
  Bei den Messungen wird jeweils bei fester Eingangsleistung die Ausgangsspannung der Diode gemessen.
	...
	Wann immer stehende Wellen auftreten, kommt ausschließlich die am Koppler reflektierte Leistung an der Messdiode an, sodass die gemessene Spannung hier geringer ist, als wenn Wellen die Messleitung wieder über den Koppler verlassen können.
  ...
  mit $P_\text{in}=\SI{10}{dBm}$.
	...
	%TODO soll insertion loss Durchlassdämpfung sein? Das passt halt nicht sehr gut. ja
	...
	%TODO Durchlassdämpfung wie oben. ja
