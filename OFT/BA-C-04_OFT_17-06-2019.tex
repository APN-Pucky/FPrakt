...
\begin{document}
	...
	\begin{titlepage}
		\centering
		{\scshape\LARGE Korrektur von Versuchsbericht zu \par}
		\vspace{1cm}
...
Der Grad der Ordnung musste deshalb extrapoliert werden, aber dies war mit großer Sicherheit möglich, wie die geringen Abweichungen von der Fitfunktion in \crefrange{fig_3_mix_1}{fig_3_mix_2} zeigen.
