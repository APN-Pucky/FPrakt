...
\begin{document}
  ...
  \section{Theorie}
	...
	Es wird sich im folgenden jedoch zeigen, dass die Unsicherheiten die dadurch entstehen, dass beispielsweise Maxima nicht genau auf dem Schirm ablesbar sind, deutlich gegen über den der Kalibration überwiegen. %TODO verständlich? nein.
...
\begin{itemize}
	...
	\begin{figure}[H]
        ...
        \label{fig_4_halb}
    \end{figure}
	Beim Bruch wird ein Hochpassfilter verwendet, um die 2 im Nenner zu entfernen.
	Der Hochpassfilter lässt nur den Teil des Bildes bestehen, der schnellen Änderungen unterworfen ist, also wäre zu erwarten, dass nur der Zähler übrig bleibt, welcher hohe Frequenzen zum Darstellen scharfer Kanten benötigt.
	Die 2 verschwindet, da die Frequenz des Gitters gefiltert wird und somit auch die Form der 2.
	In \cref{fig_4_halb} verschwindet der Nenner und der Zähler bleibt bestehen.
	Analog kann man mittels eines Tiefpassfilters den Zähler eliminieren.
	%TODO besseren Ansatz habe ich nicht.
