...
\begin{document}
  ...
  Dann wird ein Gitter (später Gitter Nr.2) in den Strahl gebracht und in verschiedenen Abständen das Bild auf dem Schirm aufgenommen.
	...
	Dies entspricht den Erwartungen, da gemäß der Fraunhofer-Beugung (vgl. \cref{sec_fraunhofer} erst im Fernfeld das Beugungsbild in Form von $\left(\frac{\sin x}{x}\right)^2$ auftritt.
