...
\begin{itemize}
	\item{Fourier-Schriftzug:}
		\begin{figure}[H]
	        ...
	        \label{fig_4_fourier}
	    \end{figure}
	Es ist in  gut zu erkennen, dass mithilfe des Tiefpasses die überlagernde Frequenz herausgefiltert werden konnte. %TODO
	...
	\end{equation}
	welches das Intervall $1/\sqrt{2}$ beinhält.
	...
	\begin{figure}[H]
			\includegraphics[width=0.75\linewidth]{raw/4/4_k_2}
			\caption{
