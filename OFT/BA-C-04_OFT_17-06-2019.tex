...
\begin{itemize}
	...
	%TODO why
	\item{Quadratgitter:} Die Fouriertransformierte eines Quadratgitters ist eine quadratisches Punktgitter.
	...
	\begin{figure}[H]
			...
			\label{fig_matrix}
	\end{figure}
	\item{Schraube:} Der Hochpass macht die großen Strukturen unsichtbar und es bleiben nur die Bereiche zu erkennen, in denen schnelle räumliche Änderungen im Bild sind.
