...
\begin{figure}[H]
        ...
        \caption%
        {
				Kameraaufnahmen und Intensitätsprofile für verschiedene Gitter.
				Die x-Achse \enquote{Position} sagt nichts über die absolute Position des Maximums aus, sondern dient lediglich dem Bestimmen von Abständen zwischen Peaks.
				}
        \label{fig_2_mix_1}
    \end{figure}
	...
	Dies muss auf ein Untergehen der Peaks im Rauschen oder eine sonstige Untermodulation zurückgeführt werden. %TODO kp, was da für Untermodulation sein könnte. Ist so bissl unbestimmt.
