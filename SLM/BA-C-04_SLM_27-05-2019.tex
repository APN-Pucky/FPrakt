...
\begin{figure}[H]
	...
	\end{figure}
		...
		Analog stellt man in \cref{fig_sinc3} fest, dass $c_h=1-2/9$ beträgt und ebenfalls das erste Minimum nicht aufgelöst werden konnte.
...
%TODO random leereseiten
		...
		%4.3.2, 4.3.3
		%TODO Bilder
 		\cref{fig_beug_mix} zeigt einige mit der Kamera aufgenommene Beugungsbilder.
