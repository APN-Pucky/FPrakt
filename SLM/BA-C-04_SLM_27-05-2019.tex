...
\begin{figure}[H]
	...
	\end{figure}
		...
		Mit einer Betrachtung der Unsicherheit welche durch eine Rechteckverteilung der Breite 1 am Punkt $m=9$ abgeschätzt und es folgt mit $m=\SI{9+-0.3}{}$ Tastgrade von $c_v=\SI{0.444(15)}{}$ und $c_h=\SI{0.222(7)}{}$.
...
\begin{figure}[H]
        ...
        \begin{subfigure}[b]{0.475\textwidth}
            ...
            \caption[]%
            {Gitter: Rille: \SI{2}{px}, Erhöhung: \SI{2}{px}}
            \label{fig_grid_2_2}
        \end{subfigure}
        \quad
        \begin{subfigure}[b]{0.475\textwidth}
