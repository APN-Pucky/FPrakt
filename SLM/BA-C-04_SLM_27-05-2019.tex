...
\begin{document}
	...
	Für den verwendeten LC-Modulator wird mit zwei verschiedenen Methoden der Pixelabstand bestimmt und der Füllfaktor der Zellen wird abgeschätzt. %TODO hier Werte?
	Außerdem wird die Abhängigkeit der Ausgangspolarisation des Modulators von dem eingestellten Grauwert untersucht und diskutiert. %TODO eig. des Lichtes, kp eig. klar aber....
...
\end{table}
			...
			Wenn man die gemessenen Pixelabstände in \cref{tb_pixel} und \cref{tb_gitter} mit der Herstellerangabe gemäß \cite{Handbuch} von \SI{32}{\micro \meter}, die auf \SI{\pm 3}{\micro \meter} genau bestimmt werden können soll, vergleicht, stellt man fest, dass dies innerhalb der Messunsicherheiten der Fall ist. %TODO geiler Satz.
...
\begin{figure}[H]
	...
	\end{figure}
		...
		%TODO hast du hier jetzt einfach auch die Werte von Jannik genommen? Steht nirgendwo und ist halt bissl meh, weil wir haben ja Werte, nur halt horizontal nicht so viele.
...
\begin{figure}[H] %TODO die Achsenbeschriftungen sind extrem klein.
	...
	\end{figure}
		...
		% Beobachtung, Änderung mit Strukturgröße
			...
			Bei der Betrachtung von \cref{fig_beug} kann man innerhalb der Messunsicherheiten feststellen, dass der Beugungswirkungsgrad mit zunehmendem Grauwert abnimmt. %TODO ich bin dagegegen weil großer ERror
			...
			%TODO ich bin mir nicht sehr sicher, wie true das ist. Und oben steht halt proportional und nicht antiproportional, aber ich glaube da ist die anleitung einfach unpräzise %TODO IDK,KP,WTF
...
\begin{figure}[H]
    ...
    \end{figure}
			...
			Analog dazu würde sich bei einem statisch auf eine dünne Glasplatte aufgeprägten Hologramms bei Verwendung nur einer Hälfte der Glasplatte immer noch das volle Beugungsbild ergeben und nur die Intensität halbiert werden. %TODO Intensität halbiert ist imo wrong.
	...
	Zuletzt wurde der LC-Modulator verwendet, um Hologramme zu erzeugen, indem fouriertransformierte DOEs verwendet wurden. %TODO fouriertransform klein?!?
