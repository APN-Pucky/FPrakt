...
\begin{figure}[H] %TODO die Achsenbeschriftungen sind extrem klein.
	...
	\end{figure}
		...
		% Beobachtung, Änderung mit Strukturgröße
			...
			%TODO ich bin mir nicht sehr sicher, wie true das ist. Und oben steht halt proportional und nicht antiproportional, aber ich glaube da ist die anleitung einfach unpräzise
...
\begin{figure}[H]
    ...
    \end{figure}
			...
			Anders gesagt schickt die eine Hälfte des LC-Modulators die Lichtstrahlen so auf den Sensor, dass Ringe entstehen und die andere so, dass Rechtecke entstehen.
