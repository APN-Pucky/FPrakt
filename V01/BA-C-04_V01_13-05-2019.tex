...
\begin{document}
  ...
  \section{Theorie}
	...
	% Welche Einflüsse?
	% Was passiert bei Zerfällen mit mehreren Gamma-Linien?
	% welche anderen Effekte kann man sehen?
	% Spektren vorhersagen: 22Na, 60Co, 137Cs
		...
		Dazu tritt der Rückstreuuntergrund, der durch Comptoneffekte außerhalb des Absorbers entsteht, bei denen die gestreuten Photonen dann im Detektor nachgewiesen werden.
		Der Photoeffekt führt zur Messung der Photolinie, die dem Full Energy Peak entspricht.
		Bei Zerfällen mit mehreren Gamma-Linien überlagern sich mehrere Compton-, Rückstreu- und Full Energy Peaks.
	...
	% Was ist wichtig bei Verwendung von Halbleiterdetektor?
	% Warum muss der gekühlt werden?
	% Was braucht man sonst noch?
	% Warum Schicht undotierte Schicht?-> breitere RLZ
	% Unterschiede Szintallator und Halbleiter
...
% Photomultiplier? Was braucht man da sonst noch?->Lichtleiter, Vorverstärker.
	...
	% wie beeinflusst die Kalibrierunsicherheit die späteren Messungen?
	% Was bestimmt Peakbreite?
	% Warum misst man die Breite?->Zusammenhang zu
	% Definition FWHM, Sigma
	% kann man hier Kalibrierunsicherheit vernachlässigen?
	...
	Die Kalibrierunsicherheit tritt als systematischer Fehler in den Messungen auf.
	...
	Es wurden bei jeder Messung die ersten 95 Kanäle vernachlässigt, da all diese nahe Null Ereignisse liefern und die Erstellung eines physikalischen Modells des Spektrums im Randbereich unmöglich machen.
  ...
  Mittels der Literaturwerte der Peaks der $^{22}$Na-Probe (\SI{511}{keV} und \SI{1274}{keV} \cite{Anleitung}) lassen sich die Kanäle umrechnen zu einer Energieskala.
	...
	Da ein linearer Fit zwischen zwei Punkten mit Unsicherheiten mit dem \enquote{Least-Square-Fit} nicht zielführend ist, werden drei Geraden durch die Messintervalle gelegt, sodass sich eine mittlere, maximale und minimale Steigung ergibt.
...
\subsubsection{Diskussion}
	...
	Anhand der Zerfallsreihen lässt sich damit die Probe der Uran-Radium-Reihe zuordnen.
