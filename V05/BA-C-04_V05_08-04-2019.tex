...
\begin{document}
  ...
  %TODO 150ns bestätigt
  \section{Theorie}
	% wdh. Texte
	% wdh. Besprechung
	\subsection{Zerfall von Titan-44}

	Das Zerfallsschema von Titan-44 ist in \cref{fig_Zerfallsschema} dargestellt. Titan-44 zerfällt über Elektroneneinfang mit einer Halbwertszeit von \SI{2,44}{} Tagen zu einem angeregten Niveau von Scandium-44 (\cite{Anleitung}). %TODO die 2,44 sind hier nicht Ti44 sonder Sc44***, also falsch. Dein Bild sagt 59 Jahre. Die Anleitung sagt 48 Jahre. Interweb sagt 60
	...
	%TODO in der Graphik gibt es auch noch nen Zweiter 0,4% Pfeil auf den nicht eingegangen wird., bzw. könnte das auch grund für einen Fehler Error/Korrelation sein.
	\begin{figure}[H]
	...
	\end{equation}
	Das dabei entstandene Positron wird durch Wechselwirkung mit dem Rest der Probe abgebremst. %TODO + unter Aussendung von Bremsstrahlung?
	...
	Gleichzeitig kann durch Umgebungswechselwirkung Orthopositronium in Parapositronium übergehen, was während der vergleichsweise langen Zerfallsdauer wahrscheinlich ist. %TODO kp., aber nur durch Umgebung?
	...
	Da die Wechselwirkung mit Atomkernen aufgrund des geringen Anteils des Kernvolumens am Atomvolumen einen deutlich geringeren Wirkungsquerschnitt hat, überwiegt die Wechselwirkung mit Hüllenelektronen. %TODO Naja Elektronen sind Punktteilchen also mit einem Volumen von Null
	...
	Hierbei wird statt dem Überschreiten eines bestimmten Schwellenwerts der Nulldurchgang des näherungsweise sinusförmigen (eine Periode) Signals verwendet als zu vergleichender Zeitpunkt verwendet. %TODO hier eine Bild/Scan aus Anleitung?
  ...
  \subsubsection{Zeitkalibrierung}\label{sss_zeitkali}
	...
	\begin{figure}[H]
		...
		\cref{eq_mittel} ist also der gewichtete und normierte Mittelwert der Lebesndauern und die Unsicherheit ergibtsich aus dem Quotienten der Standardabweichung und der Wurzel der Anzahl der Messpunkte über welche gemittelt wird ($\frac{s}{\sqrt{N}}$).

		Es ergibt sich $\tau_5=\SI{229+-3}{ns}$ im Bereich von $\SI{1.74}{\mu s}$ bis $\SI{3}{\mu s}$ und umgekehrt in $\SI{0.4}{\mu s}$ bis $\SI{1.74}{\mu s}$ folgt $\tau_6=\SI{233+-4}{\mu s}$.
		...
		\begin{tabular}{c| c | c | c | c  }
			 ...
			 1&Halbwertsbreite&\SI{4.7+-0.12}{}&\SI{215+-6}{}&\SI{149+-4}{}\\
			 2&Halbwertsbreite&\SI{4.6+-0.12}{}&\SI{217+-6}{}&\SI{151+-4}{}\\
			 3&Fit&\SI{4.69+-0.07}{}&\SI{213+-3}{}&\SI{147+-2}{} \\
			 4&Fit&\SI{4.39+-0.06}{}&\SI{228+-3}{}&\SI{158+-2}{} \\
			 5&Mittelwert&\SI{4.37+-0.06}{}&\SI{229+-3}{}&\SI{159+-2}{}\\
			 6&Mittelwert&\SI{4.29+-0.07}{}&\SI{233+-4}{}&\SI{162+-3}{}\\
		\end{tabular}
		\caption{
