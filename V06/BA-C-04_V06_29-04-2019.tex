...
\begin{document}
	...
	Mit dessen Hilfe wird durch einen Kurzie-Plot die Grenzenergie des Übergangs in den angeregten Zustand des entstehenden Ba-137 bestimmt.
	Dies ist insofern erfolgreich, als dass das Ergebnis von \SI{538 \pm 10}{keV} um weniger als \SI{10}{\percent} und um weniger als die dreifache Standardunsicherheit vom Literaturwert abweicht.
  ...
  \section{Theorie}
	...
	Konversionselektronen treten dadurch auf, dass, wenn das angeregte $^{137}$Ba wieder in den Grundzustand übergeht und der Energieübertrag zur Aussendung eines Elektrons aus der K- oder L-Schale führt. %TODO wieso wieder?
	...
	\subsubsection{Unsicherheiten}
	Jegliche Unsicherhieten werden nach GUM bestimmt und berechnet.
...
\begin{figure}[H]
	...
	Dies ist zunächst darauf zurückgeführt werden, dass die Kalibrierung weit vom Kalibrierpunkt entfernt weniger präzise wird, was ein Grund für die Abweichung sein kann.
	...
	Diese Abweichung ist auf die oben diskutierten Gründe zurückzuführen.
